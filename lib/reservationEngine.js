...
export async function createReservation(userId, dateStr) {
  ...
  // ── RÈGLE PÉNALITÉ : Bloquer si pénalisé ──
  ...
  // ── RÈGLE 1 : Max 1 réservation active ──
  ...
  // ── RÈGLE 2 : Fenêtre de réservation ──
  ...
  // ── RÈGLE 3 : Rotation (anti-monopolisation) ──
...
async function countConsecutiveDays(userId, targetDateStr) {
  // Count how many consecutive days (ending the day before targetDate)
  // the user has had confirmed reservations
  let count = 0;
